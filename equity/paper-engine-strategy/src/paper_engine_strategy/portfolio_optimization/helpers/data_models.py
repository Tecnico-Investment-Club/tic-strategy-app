...
class AssetID(pydantic.BaseModel):
    ...
    type: AssetType = pydantic.Field(..., description="Indicates the type of Asset")
    ticker: str = pydantic.Field(..., description="Indicates the Asset ticker")
...
momentum_type = {
    "MACD": Momentum_Type.MACD,
    "Sigmoid": Momentum_Type.Sigmoid,
    "Cumulative_Returns": Momentum_Type.Cumulative_Returns,
}
...
mean_rev_type = {
    "BOLLINGER_BANDS": Mean_Rev_Type.Bollinger_Bands,
    "RSI": Mean_Rev_Type.RSI
}
...
rebalancing_period = {
    "DAILY": Rebalancing_Period.DAILY,
}
...
hurst_filter = {
    "STANDARD": HurstFilter.STANDARD,
    "MODERATE": HurstFilter.MODERATE,
    "STRICT": HurstFilter.STRICT,
}
...
rsi_filter = {
    "STANDARD": RSIFilter.STANDARD,
    "STRICT": RSIFilter.STRICT,
    "LENIENT": RSIFilter.LENIENT,
}
...
class Rebalance_Constraints:
    def __init__(
        ...
        distance_method=tc.DistanceMethod.EUCLIDEAN,
        Gamma=0.5,
        Delta_Range=(-10, 10),
        delta_step=0.1,
    ):
