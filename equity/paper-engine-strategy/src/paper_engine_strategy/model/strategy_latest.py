...
class StrategyLatest(State):
    """Strategy Latest state."""

    strategy_id: int  # entity key
    asset_id_type: str
    asset_id: str
    datadate: Optional[datetime] = None
    ...
    @classmethod
    def from_source(cls, record: Record) -> "StrategyLatest":
    ...
    @classmethod
    def from_target(cls, record: Tuple) -> "StrategyLatest":
    ...
    def removal_instance(
        ...
        (res.strategy_id, res.asset_id_type, res.asset_id) = key
